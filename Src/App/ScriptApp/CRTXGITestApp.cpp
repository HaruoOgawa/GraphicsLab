...
namespace app
{
	...
	bool CRTXGITestApp::Release(api::IGraphicsAPI* pGraphicsAPI)
	{
		return true;
	}
	...
	bool CRTXGITestApp::ProcessInput(api::IGraphicsAPI* pGraphicsAPI)
	{
		return true;
	}

	bool CRTXGITestApp::Resize(int Width, int Height)
	{
	...
	bool CRTXGITestApp::Update(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker, const std::shared_ptr<input::CInputState>& InputState)
	{
	...
	bool CRTXGITestApp::LateUpdate(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker)
	{
	...
	bool CRTXGITestApp::FixedUpdate(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker)
	{
	...
	bool CRTXGITestApp::Draw(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker, const std::shared_ptr<input::CInputState>& InputState,
	...
	std::shared_ptr<graphics::CDrawInfo> CRTXGITestApp::GetDrawInfo() const
	{
		return m_DrawInfo;
	}

	// 起動準備完了
	bool CRTXGITestApp::OnStartup(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker, const std::shared_ptr<gui::IGUIEngine>& GUIEngine)
	{
	...
	// ロード完了イベント
	bool CRTXGITestApp::OnLoaded(api::IGraphicsAPI* pGraphicsAPI, physics::IPhysicsEngine* pPhysicsEngine, resource::CLoadWorker* pLoadWorker, const std::shared_ptr<gui::IGUIEngine>& GUIEngine)
	{
	...
	// フォーカスイベント
	void CRTXGITestApp::OnFocus(bool Focused, api::IGraphicsAPI* pGraphicsAPI, resource::CLoadWorker* pLoadWorker)
	{
	...
	// エラー通知イベント
	void CRTXGITestApp::OnAssertError(const std::string& Message)
	{
#ifdef USE_GUIENGINE
	...
	// Getter
	std::vector<std::shared_ptr<object::C3DObject>> CRTXGITestApp::GetObjectList() const
	{
	...
	std::shared_ptr<scene::CSceneController> CRTXGITestApp::GetSceneController() const
	{
